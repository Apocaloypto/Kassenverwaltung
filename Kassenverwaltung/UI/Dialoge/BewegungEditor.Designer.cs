namespace Kassenverwaltung.UI.Dialoge
{
   partial class BewegungEditor
   {
      ...
      private void InitializeComponent()
      {
         ...
         cbxKategorie.Size = new Size(217, 23);
         ...
         monBetrag.Size = new Size(217, 24);
         ...
         tbxVerwendung.Size = new Size(217, 170);
         tbxVerwendung.TabIndex = 7;
         // 
         // btnOK
         // 
         btnOK.Dock = DockStyle.Fill;
         btnOK.Location = new Point(176, 269);
         btnOK.Name = "btnOK";
         ...
         btnCancel.Location = new Point(276, 269);
